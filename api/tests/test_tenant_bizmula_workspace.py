...
class WorkspaceAPIWithTenantSchemaTestCase(APITestCase, FastTenantTestCase):
    ...
    def test_post_with_anonymous_user(self):
        ...
        response = self.unauthorized_client.post('/api/tenantworkspace/', data, format="json")
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_post_with_non_management_user(self):
        ...
        response = self.authorized_client.post('/api/tenantworkspace/', data, format="json")
    ...
    def test_put(self):
        ...
        response = self.unauthorized_client.put('/api/tenantworkspace/999/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_put_with_authorization(self):
        ...
        response = self.authorized_client.put('/api/tenantworkspace/666/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
