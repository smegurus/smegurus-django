...
class APICityOptionWithTenantSchemaTestCase(APITestCase, TenantTestCase):
    ...
    def test_post(self):
        ...
        response = self.unauthorized_client.post('/api/tenantcityoption/', json.dumps(data), content_type='application/json')
    ...
    def test_post_with_authentication(self):
        ...
        response = self.authorized_client.post('/api/tenantcityoption/', json.dumps(data), content_type='application/json')
    ...
    def test_put(self):
        ...
        response = self.unauthorized_client.put('/api/tenantcityoption/1/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_put_with_authorization(self):
        ...
        response = self.authorized_client.put('/api/tenantcityoption/1/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
