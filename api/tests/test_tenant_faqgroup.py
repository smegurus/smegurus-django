...
class APIFAQGroupWithTenantSchemaTestCase(APITestCase, TenantTestCase):
    fixtures = []
    ...
    def setUp(self):
        ...
        super(APIFAQGroupWithTenantSchemaTestCase, self).setUp()
    ...
    @transaction.atomic
    def tearDown(self):
        FAQGroups = FAQGroup.objects.delete_all()
        ...
        for user in users.all():
            user.delete()
        # super(APIFAQGroupWithTenantSchemaTestCase, self).tearDown()

    @transaction.atomic
    def test_list_with_anonymous_user(self):
        response = self.unauthorized_client.get('/api/tenantfaqgroup/')
    ...
    def test_list_with_authenticated_management_group_user(self):
        ...
        response = self.authorized_client.get('/api/tenantfaqgroup/')
    ...
    def test_post_with_anonymous_user(self):
        ...
        response = self.unauthorized_client.post('/api/tenantfaqgroup/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_post_with_authenticated_management_group_user(self):
        ...
        response = self.authorized_client.post('/api/tenantfaqgroup/', json.dumps(data), content_type='application/json')
    ...
    def test_put_with_anonymous_user(self):
        ...
        response = self.unauthorized_client.put('/api/tenantfaqgroup/666/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_put_with_authenticated_management_user(self):
        ...
        response = self.authorized_client.put('/api/tenantfaqgroup/666/', json.dumps(data), content_type='application/json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_with_anonymous_user(self):
        response = self.unauthorized_client.delete('/api/tenantfaqgroup/1/')
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
    ...
    def test_delete_with_authenticated_management_user(self):
        ...
        self.user.groups.add(org_admin_group)
        self.user.save()
        response = self.authorized_client.delete('/api/tenantfaqgroup/1/')
