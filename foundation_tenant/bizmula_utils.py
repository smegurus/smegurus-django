...
class BizmulaAPI(DocxspressoAPI):
    ...
    def do_q28(self, answer, api):
        ...
        api.add_unordered_list("research_sources", arr)
    ...
    def do_q29(self, answer, api):
        ...
        arr.append(answer.content['var_2'])
        arr.append(answer.content['var_3'])
        api.add_unordered_list("similar_businesses", arr)
    ...
    def do_q30(self, answer, api):
        ...
        arr.append(answer.content['var_2'])
        arr.append(answer.content['var_3'])
        api.add_unordered_list("industry_contacts", arr)
    ...
    def do_q99(self, answer, api):
        api.add_currency("unit_sales_m1", answer.content['m1'])
        api.add_currency("unit_sales_m2", answer.content['m2'])
        api.add_currency("unit_sales_m3", answer.content['m3'])
        api.add_currency("unit_sales_m4", answer.content['m4'])
        api.add_currency("unit_sales_m5", answer.content['m5'])
        api.add_currency("unit_sales_m6", answer.content['m6'])
        api.add_currency("unit_sales_m7", answer.content['m7'])
        api.add_currency("unit_sales_m8", answer.content['m8'])
        api.add_currency("unit_sales_m9", answer.content['m9'])
        api.add_currency("unit_sales_m10", answer.content['m10'])
        api.add_currency("unit_sales_m11", answer.content['m11'])
        api.add_currency("unit_sales_m12", answer.content['m12'])
        api.add_currency("unit_sales_y1_total", answer.content['yr1_total'])
        api.add_currency("unit_sales_m13", answer.content['m13'])
        api.add_currency("unit_sales_m14", answer.content['m14'])
        api.add_currency("unit_sales_m15", answer.content['m15'])
        api.add_currency("unit_sales_m16", answer.content['m16'])
        api.add_currency("unit_sales_m17", answer.content['m17'])
        api.add_currency("unit_sales_m18", answer.content['m18'])
        api.add_currency("unit_sales_m19", answer.content['m19'])
        api.add_currency("unit_sales_m20", answer.content['m20'])
        api.add_currency("unit_sales_m21", answer.content['m21'])
        api.add_currency("unit_sales_m22", answer.content['m22'])
        api.add_currency("unit_sales_m23", answer.content['m23'])
        api.add_currency("unit_sales_m24", answer.content['m24'])
        api.add_currency("unit_sales_y2_total", answer.content['yr2_total'])
        api.add_currency("unit_sales_m25", answer.content['m25'])
        api.add_currency("unit_sales_m26", answer.content['m26'])
        api.add_currency("unit_sales_m27", answer.content['m27'])
        api.add_currency("unit_sales_m28", answer.content['m28'])
        api.add_currency("unit_sales_m29", answer.content['m29'])
        api.add_currency("unit_sales_m30", answer.content['m30'])
        api.add_currency("unit_sales_m31", answer.content['m31'])
        api.add_currency("unit_sales_m32", answer.content['m32'])
        api.add_currency("unit_sales_m33", answer.content['m33'])
        api.add_currency("unit_sales_m34", answer.content['m34'])
        api.add_currency("unit_sales_m35", answer.content['m35'])
        api.add_currency("unit_sales_m36", answer.content['m36'])
        api.add_currency("unit_sales_y3_total", answer.content['yr3_total'])
    ...
    def do_q101(self, answer, api):
        api.add_currency("cogs_materials_m1", answer.content['materials_month_1_other'] if answer.content['materials_month_1_other'] else answer.content['materials_month_1'])
        api.add_currency("cogs_materials_m2", answer.content['materials_month_2_other'] if answer.content['materials_month_2_other'] else answer.content['materials_month_2'])
        api.add_currency("cogs_materials_m3", answer.content['materials_month_3_other'] if answer.content['materials_month_3_other'] else answer.content['materials_month_3'])
        api.add_currency("cogs_materials_m4", answer.content['materials_month_4_other'] if answer.content['materials_month_4_other'] else answer.content['materials_month_4'])
        api.add_currency("cogs_materials_m5", answer.content['materials_month_5_other'] if answer.content['materials_month_5_other'] else answer.content['materials_month_5'])
        api.add_currency("cogs_materials_m6", answer.content['materials_month_6_other'] if answer.content['materials_month_6_other'] else answer.content['materials_month_6'])
        api.add_currency("cogs_materials_m7", answer.content['materials_month_7_other'] if answer.content['materials_month_7_other'] else answer.content['materials_month_7'])
        api.add_currency("cogs_materials_m8", answer.content['materials_month_8_other'] if answer.content['materials_month_8_other'] else answer.content['materials_month_8'])
        api.add_currency("cogs_materials_m9", answer.content['materials_month_9_other'] if answer.content['materials_month_9_other'] else answer.content['materials_month_9'])
        api.add_currency("cogs_materials_m10", answer.content['materials_month_10_other'] if answer.content['materials_month_10_other'] else answer.content['materials_month_10'])
        api.add_currency("cogs_materials_m11", answer.content['materials_month_11_other'] if answer.content['materials_month_11_other'] else answer.content['materials_month_11'])
        api.add_currency("cogs_materials_m12", answer.content['materials_month_12_other'] if answer.content['materials_month_12_other'] else answer.content['materials_month_12'])
        api.add_currency("cogs_materials_y1_total", answer.content['materials_month_12_other'] if answer.content['materials_month_12_other'] else answer.content['materials_month_12'])

        api.add_currency("cogs_materials_m13", answer.content['materials_month_13_other'] if answer.content['materials_month_1_other'] else answer.content['materials_month_13'])
        api.add_currency("cogs_materials_m14", answer.content['materials_month_14_other'] if answer.content['materials_month_2_other'] else answer.content['materials_month_14'])
        api.add_currency("cogs_materials_m15", answer.content['materials_month_15_other'] if answer.content['materials_month_3_other'] else answer.content['materials_month_15'])
        api.add_currency("cogs_materials_m16", answer.content['materials_month_16_other'] if answer.content['materials_month_4_other'] else answer.content['materials_month_16'])
        api.add_currency("cogs_materials_m17", answer.content['materials_month_17_other'] if answer.content['materials_month_5_other'] else answer.content['materials_month_17'])
        api.add_currency("cogs_materials_m18", answer.content['materials_month_18_other'] if answer.content['materials_month_6_other'] else answer.content['materials_month_18'])
        api.add_currency("cogs_materials_m19", answer.content['materials_month_19_other'] if answer.content['materials_month_7_other'] else answer.content['materials_month_19'])
        api.add_currency("cogs_materials_m20", answer.content['materials_month_20_other'] if answer.content['materials_month_8_other'] else answer.content['materials_month_20'])
        api.add_currency("cogs_materials_m21", answer.content['materials_month_21_other'] if answer.content['materials_month_9_other'] else answer.content['materials_month_21'])
        api.add_currency("cogs_materials_m22", answer.content['materials_month_22_other'] if answer.content['materials_month_10_other'] else answer.content['materials_month_22'])
        api.add_currency("cogs_materials_m23", answer.content['materials_month_23_other'] if answer.content['materials_month_11_other'] else answer.content['materials_month_23'])
        api.add_currency("cogs_materials_m24", answer.content['materials_month_24_other'] if answer.content['materials_month_12_other'] else answer.content['materials_month_24'])
        api.add_currency("cogs_materials_y2_total", answer.content['materials_month_24_other'] if answer.content['materials_month_24_other'] else answer.content['materials_month_24'])

        api.add_currency("cogs_materials_m25", answer.content['materials_month_25_other'] if answer.content['materials_month_25_other'] else answer.content['materials_month_25'])
        api.add_currency("cogs_materials_m26", answer.content['materials_month_26_other'] if answer.content['materials_month_26_other'] else answer.content['materials_month_26'])
        api.add_currency("cogs_materials_m27", answer.content['materials_month_27_other'] if answer.content['materials_month_27_other'] else answer.content['materials_month_27'])
        api.add_currency("cogs_materials_m28", answer.content['materials_month_28_other'] if answer.content['materials_month_28_other'] else answer.content['materials_month_28'])
        api.add_currency("cogs_materials_m29", answer.content['materials_month_29_other'] if answer.content['materials_month_29_other'] else answer.content['materials_month_29'])
        api.add_currency("cogs_materials_m30", answer.content['materials_month_30_other'] if answer.content['materials_month_30_other'] else answer.content['materials_month_30'])
        api.add_currency("cogs_materials_m31", answer.content['materials_month_31_other'] if answer.content['materials_month_31_other'] else answer.content['materials_month_31'])
        api.add_currency("cogs_materials_m32", answer.content['materials_month_32_other'] if answer.content['materials_month_32_other'] else answer.content['materials_month_32'])
        api.add_currency("cogs_materials_m33", answer.content['materials_month_33_other'] if answer.content['materials_month_33_other'] else answer.content['materials_month_33'])
        api.add_currency("cogs_materials_m34", answer.content['materials_month_34_other'] if answer.content['materials_month_34_other'] else answer.content['materials_month_34'])
        api.add_currency("cogs_materials_m35", answer.content['materials_month_35_other'] if answer.content['materials_month_35_other'] else answer.content['materials_month_35'])
        api.add_currency("cogs_materials_m36", answer.content['materials_month_36_other'] if answer.content['materials_month_36_other'] else answer.content['materials_month_36'])
        api.add_currency("cogs_materials_y3_total", answer.content['materials_month_35_other'] if answer.content['materials_month_36_other'] else answer.content['materials_month_36'])

        api.add_currency("cogs_labour_m1", answer.content['labour_month_1_other'] if answer.content['labour_month_1_other'] else answer.content['labour_month_1'])
        api.add_currency("cogs_labour_m2", answer.content['labour_month_2_other'] if answer.content['labour_month_2_other'] else answer.content['labour_month_2'])
        api.add_currency("cogs_labour_m3", answer.content['labour_month_3_other'] if answer.content['labour_month_3_other'] else answer.content['labour_month_3'])
        api.add_currency("cogs_labour_m4", answer.content['labour_month_4_other'] if answer.content['labour_month_4_other'] else answer.content['labour_month_4'])
        api.add_currency("cogs_labour_m5", answer.content['labour_month_5_other'] if answer.content['labour_month_5_other'] else answer.content['labour_month_5'])
        api.add_currency("cogs_labour_m6", answer.content['labour_month_6_other'] if answer.content['labour_month_6_other'] else answer.content['labour_month_6'])
        api.add_currency("cogs_labour_m7", answer.content['labour_month_7_other'] if answer.content['labour_month_7_other'] else answer.content['labour_month_7'])
        api.add_currency("cogs_labour_m8", answer.content['labour_month_8_other'] if answer.content['labour_month_8_other'] else answer.content['labour_month_8'])
        api.add_currency("cogs_labour_m9", answer.content['labour_month_9_other'] if answer.content['labour_month_9_other'] else answer.content['labour_month_9'])
        api.add_currency("cogs_labour_m10", answer.content['labour_month_10_other'] if answer.content['labour_month_10_other'] else answer.content['labour_month_10'])
        api.add_currency("cogs_labour_m11", answer.content['labour_month_11_other'] if answer.content['labour_month_11_other'] else answer.content['labour_month_11'])
        api.add_currency("cogs_labour_m12", answer.content['labour_month_12_other'] if answer.content['labour_month_12_other'] else answer.content['labour_month_12'])
        api.add_currency("cogs_labour_y1_total", answer.content['labour_month_12_other'] if answer.content['labour_month_12_other'] else answer.content['labour_month_12'])

        api.add_currency("cogs_labour_m13", answer.content['labour_month_13_other'] if answer.content['labour_month_1_other'] else answer.content['labour_month_13'])
        api.add_currency("cogs_labour_m14", answer.content['labour_month_14_other'] if answer.content['labour_month_2_other'] else answer.content['labour_month_14'])
        api.add_currency("cogs_labour_m15", answer.content['labour_month_15_other'] if answer.content['labour_month_3_other'] else answer.content['labour_month_15'])
        api.add_currency("cogs_labour_m16", answer.content['labour_month_16_other'] if answer.content['labour_month_4_other'] else answer.content['labour_month_16'])
        api.add_currency("cogs_labour_m17", answer.content['labour_month_17_other'] if answer.content['labour_month_5_other'] else answer.content['labour_month_17'])
        api.add_currency("cogs_labour_m18", answer.content['labour_month_18_other'] if answer.content['labour_month_6_other'] else answer.content['labour_month_18'])
        api.add_currency("cogs_labour_m19", answer.content['labour_month_19_other'] if answer.content['labour_month_7_other'] else answer.content['labour_month_19'])
        api.add_currency("cogs_labour_m20", answer.content['labour_month_20_other'] if answer.content['labour_month_8_other'] else answer.content['labour_month_20'])
        api.add_currency("cogs_labour_m21", answer.content['labour_month_21_other'] if answer.content['labour_month_9_other'] else answer.content['labour_month_21'])
        api.add_currency("cogs_labour_m22", answer.content['labour_month_22_other'] if answer.content['labour_month_10_other'] else answer.content['labour_month_22'])
        api.add_currency("cogs_labour_m23", answer.content['labour_month_23_other'] if answer.content['labour_month_11_other'] else answer.content['labour_month_23'])
        api.add_currency("cogs_labour_m24", answer.content['labour_month_24_other'] if answer.content['labour_month_12_other'] else answer.content['labour_month_24'])
        api.add_currency("cogs_labour_y2_total", answer.content['labour_month_12_other'] if answer.content['labour_month_12_other'] else answer.content['labour_month_12'])

        api.add_currency("cogs_labour_m25", answer.content['labour_month_25_other'] if answer.content['labour_month_25_other'] else answer.content['labour_month_25'])
        api.add_currency("cogs_labour_m26", answer.content['labour_month_26_other'] if answer.content['labour_month_26_other'] else answer.content['labour_month_26'])
        api.add_currency("cogs_labour_m27", answer.content['labour_month_27_other'] if answer.content['labour_month_27_other'] else answer.content['labour_month_27'])
        api.add_currency("cogs_labour_m28", answer.content['labour_month_28_other'] if answer.content['labour_month_28_other'] else answer.content['labour_month_28'])
        api.add_currency("cogs_labour_m29", answer.content['labour_month_29_other'] if answer.content['labour_month_29_other'] else answer.content['labour_month_29'])
        api.add_currency("cogs_labour_m30", answer.content['labour_month_30_other'] if answer.content['labour_month_30_other'] else answer.content['labour_month_30'])
        api.add_currency("cogs_labour_m31", answer.content['labour_month_31_other'] if answer.content['labour_month_31_other'] else answer.content['labour_month_31'])
        api.add_currency("cogs_labour_m32", answer.content['labour_month_32_other'] if answer.content['labour_month_32_other'] else answer.content['labour_month_32'])
        api.add_currency("cogs_labour_m33", answer.content['labour_month_33_other'] if answer.content['labour_month_33_other'] else answer.content['labour_month_33'])
        api.add_currency("cogs_labour_m34", answer.content['labour_month_34_other'] if answer.content['labour_month_34_other'] else answer.content['labour_month_34'])
        api.add_currency("cogs_labour_m35", answer.content['labour_month_35_other'] if answer.content['labour_month_35_other'] else answer.content['labour_month_35'])
        api.add_currency("cogs_labour_m36", answer.content['labour_month_36_other'] if answer.content['labour_month_36_other'] else answer.content['labour_month_36'])
        api.add_currency("cogs_labour_y3_total", answer.content['labour_month_12_other'] if answer.content['labour_month_12_other'] else answer.content['labour_month_12'])

        api.add_currency("cogs_overhead_m1", answer.content['overhead_month_1_other'] if answer.content['overhead_month_1_other'] else answer.content['overhead_month_1'])
        api.add_currency("cogs_overhead_m2", answer.content['overhead_month_2_other'] if answer.content['overhead_month_2_other'] else answer.content['overhead_month_2'])
        api.add_currency("cogs_overhead_m3", answer.content['overhead_month_3_other'] if answer.content['overhead_month_3_other'] else answer.content['overhead_month_3'])
        api.add_currency("cogs_overhead_m4", answer.content['overhead_month_4_other'] if answer.content['overhead_month_4_other'] else answer.content['overhead_month_4'])
        api.add_currency("cogs_overhead_m5", answer.content['overhead_month_5_other'] if answer.content['overhead_month_5_other'] else answer.content['overhead_month_5'])
        api.add_currency("cogs_overhead_m6", answer.content['overhead_month_6_other'] if answer.content['overhead_month_6_other'] else answer.content['overhead_month_6'])
        api.add_currency("cogs_overhead_m7", answer.content['overhead_month_7_other'] if answer.content['overhead_month_7_other'] else answer.content['overhead_month_7'])
        api.add_currency("cogs_overhead_m8", answer.content['overhead_month_8_other'] if answer.content['overhead_month_8_other'] else answer.content['overhead_month_8'])
        api.add_currency("cogs_overhead_m9", answer.content['overhead_month_9_other'] if answer.content['overhead_month_9_other'] else answer.content['overhead_month_9'])
        api.add_currency("cogs_overhead_m10", answer.content['overhead_month_10_other'] if answer.content['overhead_month_10_other'] else answer.content['overhead_month_10'])
        api.add_currency("cogs_overhead_m11", answer.content['overhead_month_11_other'] if answer.content['overhead_month_11_other'] else answer.content['overhead_month_11'])
        api.add_currency("cogs_overhead_m12", answer.content['overhead_month_12_other'] if answer.content['overhead_month_12_other'] else answer.content['overhead_month_12'])
        api.add_currency("cogs_overhead_y1_total", answer.content['overhead_month_12_other'] if answer.content['overhead_month_12_other'] else answer.content['overhead_month_12'])

        api.add_currency("cogs_overhead_m13", answer.content['overhead_month_13_other'] if answer.content['overhead_month_1_other'] else answer.content['overhead_month_13'])
        api.add_currency("cogs_overhead_m14", answer.content['overhead_month_14_other'] if answer.content['overhead_month_2_other'] else answer.content['overhead_month_14'])
        api.add_currency("cogs_overhead_m15", answer.content['overhead_month_15_other'] if answer.content['overhead_month_3_other'] else answer.content['overhead_month_15'])
        api.add_currency("cogs_overhead_m16", answer.content['overhead_month_16_other'] if answer.content['overhead_month_4_other'] else answer.content['overhead_month_16'])
        api.add_currency("cogs_overhead_m17", answer.content['overhead_month_17_other'] if answer.content['overhead_month_5_other'] else answer.content['overhead_month_17'])
        api.add_currency("cogs_overhead_m18", answer.content['overhead_month_18_other'] if answer.content['overhead_month_6_other'] else answer.content['overhead_month_18'])
        api.add_currency("cogs_overhead_m19", answer.content['overhead_month_19_other'] if answer.content['overhead_month_7_other'] else answer.content['overhead_month_19'])
        api.add_currency("cogs_overhead_m20", answer.content['overhead_month_20_other'] if answer.content['overhead_month_8_other'] else answer.content['overhead_month_20'])
        api.add_currency("cogs_overhead_m21", answer.content['overhead_month_21_other'] if answer.content['overhead_month_9_other'] else answer.content['overhead_month_21'])
        api.add_currency("cogs_overhead_m22", answer.content['overhead_month_22_other'] if answer.content['overhead_month_10_other'] else answer.content['overhead_month_22'])
        api.add_currency("cogs_overhead_m23", answer.content['overhead_month_23_other'] if answer.content['overhead_month_11_other'] else answer.content['overhead_month_23'])
        api.add_currency("cogs_overhead_m24", answer.content['overhead_month_24_other'] if answer.content['overhead_month_12_other'] else answer.content['overhead_month_24'])
        api.add_currency("cogs_overhead_y2_total", answer.content['overhead_month_24_other'] if answer.content['overhead_month_24_other'] else answer.content['overhead_month_24'])

        api.add_currency("cogs_overhead_m25", answer.content['overhead_month_25_other'] if answer.content['overhead_month_25_other'] else answer.content['overhead_month_25'])
        api.add_currency("cogs_overhead_m26", answer.content['overhead_month_26_other'] if answer.content['overhead_month_26_other'] else answer.content['overhead_month_26'])
        api.add_currency("cogs_overhead_m27", answer.content['overhead_month_27_other'] if answer.content['overhead_month_27_other'] else answer.content['overhead_month_27'])
        api.add_currency("cogs_overhead_m28", answer.content['overhead_month_28_other'] if answer.content['overhead_month_28_other'] else answer.content['overhead_month_28'])
        api.add_currency("cogs_overhead_m29", answer.content['overhead_month_29_other'] if answer.content['overhead_month_29_other'] else answer.content['overhead_month_29'])
        api.add_currency("cogs_overhead_m30", answer.content['overhead_month_30_other'] if answer.content['overhead_month_30_other'] else answer.content['overhead_month_30'])
        api.add_currency("cogs_overhead_m31", answer.content['overhead_month_31_other'] if answer.content['overhead_month_31_other'] else answer.content['overhead_month_31'])
        api.add_currency("cogs_overhead_m32", answer.content['overhead_month_32_other'] if answer.content['overhead_month_32_other'] else answer.content['overhead_month_32'])
        api.add_currency("cogs_overhead_m33", answer.content['overhead_month_33_other'] if answer.content['overhead_month_33_other'] else answer.content['overhead_month_33'])
        api.add_currency("cogs_overhead_m34", answer.content['overhead_month_34_other'] if answer.content['overhead_month_34_other'] else answer.content['overhead_month_34'])
        api.add_currency("cogs_overhead_m35", answer.content['overhead_month_35_other'] if answer.content['overhead_month_35_other'] else answer.content['overhead_month_35'])
        api.add_currency("cogs_overhead_m36", answer.content['overhead_month_36_other'] if answer.content['overhead_month_36_other'] else answer.content['overhead_month_36'])
        api.add_currency("cogs_overhead_y3_total", answer.content['overhead_month_36_other'] if answer.content['overhead_month_36_other'] else answer.content['overhead_month_36'])
    ...
    def do_q128(self, answer, api):
        ...
        if len(answer.content) == 0:
            ...
            api.add_custom({
                "vars": [
                    {"var": 'lease_types', 'value': ['-']},
                    {"var": 'lease_details', 'value': ['-']},
                    {"var": 'lease_y1_costs', 'value': ['-']}
                ],
                "options": {
                    "element": "table"
                }
        ...
        # Generate our custom item.
        c1_dict = {"var": 'lease_types', 'value': col1_array}
        c2_dict = {"var": 'lease_details', 'value': col2_array}
        c3_dict = {"var": 'lease_y1_costs', 'value': col3_array}
