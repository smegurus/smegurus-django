# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-12-04 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='The title of this question.', max_length=255, null=True, verbose_name='Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.PositiveSmallIntegerField(choices=[(1, 'Male'), (2, 'Female'), (3, 'Another'), (4, 'Other')], default=1, help_text='The gender this User identifies as.', verbose_name='Gender')),
                ...
                ('level_of_education', models.PositiveSmallIntegerField(choices=[(1, 'Male'), (2, 'Female'), (3, 'Another'), (4, 'Other')], default=1, help_text='The highest level of education this User has attained.', verbose_name='Highest Level of Education')),
                ...
                ('place_of_birth', models.PositiveSmallIntegerField(choices=[('United States', 'United States'), ('Canada', 'Canada'), ('Zimbabwe', 'Zimbabwe'), ('Other', 'Other')], default=1, help_text='The place this User was born.', verbose_name='Place of Birth')),
                ...
                ('employment_status', models.PositiveSmallIntegerField(choices=[(1, 'employed full time'), (2, 'employed part time'), (3, 'underemployed'), (4, 'unemployed'), (5, 'receiving disability benefits'), (6, 'retired'), (7, 'Other')], default=1, help_text='The employment status of this User.', verbose_name='Employment Status')),
                ...
                ('education_or_training_status', models.PositiveSmallIntegerField(choices=[(1, 'Highschool'), (2, 'Post-Secondary'), (3, 'Private career training'), (4, 'Specialized employment program'), (5, 'Other')], default=1, help_text='The employment status of this User.', verbose_name='Education or Training Status')),
                ...
                ('why_be_entrepreneur', models.PositiveSmallIntegerField(choices=[(1, 'Highschool'), (2, 'Post-Secondary'), (3, 'Private career training'), (4, 'Specialized employment program'), (5, 'Other')], default=1, help_text='Enter why the User wants to be an entrepreneur.', verbose_name='Why be an Entrepreneur')),
                ...
                ('challenges_becoming_entrepreneur', models.PositiveSmallIntegerField(choices=[(1, 'My health'), (2, 'Childcare'), (3, 'Transportation'), (4, 'Lack of Family support'), (5, 'Language skills'), (6, 'Other')], default=1, help_text='Enter challenges in becoming entrepreneur.', verbose_name='Challenges becoming Entrepreneur')),
                ...
                ('has_owned_business', models.PositiveSmallIntegerField(choices=[(1, 'Yes'), (2, 'No'), (5, 'Other')], default=1, help_text='Enter has owned business.', verbose_name='Has Owned Business')),
