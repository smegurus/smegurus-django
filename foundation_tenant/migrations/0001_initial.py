    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(blank=True, default=foundation_tenant.utils.generate_hash, help_text='The unique salt value for this User Profile used in cryptographic signing.', max_length=127, unique=True, verbose_name='S3 Key')),
                ...
                ('image', models.ForeignKey(blank=True, help_text='An image of the item.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='abstract_thing_image_foundation_tenant_tenantme_related', to='foundation_tenant.ImageUpload')),
        ...
        migrations.AddField(
            model_name='task',
            name='image',
            field=models.ForeignKey(blank=True, help_text='An image of the item.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='abstract_thing_image_foundation_tenant_task_related', to='foundation_tenant.ImageUpload'),
        ),
        migrations.AddField(
            model_name='task',
            name='opening',
        ...
        migrations.AddField(
            model_name='task',
            name='uploads',
            field=models.ManyToManyField(blank=True, help_text='The files uploaded by a User.', related_name='task_uploads_foundation_tenant_task_related', to='foundation_tenant.FileUpload'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='notification',
            name='image',
            field=models.ForeignKey(blank=True, help_text='An image of the item.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='abstract_thing_image_foundation_tenant_notification_related', to='foundation_tenant.ImageUpload'),
        ),
        migrations.AddField(
            model_name='notification',
            name='owner',
