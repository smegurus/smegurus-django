    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='The name of this exercise.', max_length=127, null=True, verbose_name='Introduction Title')),
                ('question_ids', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(), blank=True, help_text='The question IDs that belong to this exercise.', null=True, size=None)),
                ('document_type', models.ForeignKey(blank=True, help_text='The document type that this Exercises questions belongs to.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='exercise_document_type_foundation_tenant_exercise_related', to='foundation_tenant.DocumentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_slide_id', models.PositiveSmallIntegerField(blank=True, default=0, help_text='The previous slide ID.', null=True, verbose_name='Previous Slide ID')),
                ('next_slide_id', models.PositiveSmallIntegerField(blank=True, default=0, help_text='The next slide ID.', null=True, verbose_name='Next Slide ID')),
                ('previous_exercise_id', models.PositiveSmallIntegerField(blank=True, default=0, help_text='The previous exercise ID to load up.', null=True, verbose_name='Previous Exercise ID')),
                ('next_exercise_id', models.PositiveSmallIntegerField(blank=True, default=0, help_text='The exercise ID to load up next.', null=True, verbose_name='Next Exercise ID')),
                ('page_num', models.PositiveSmallIntegerField(db_index=True, default=1, help_text='The page number in the slides for the module.', verbose_name='Page Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, default='', help_text='Gender of the person.', max_length=31, null=True, verbose_name='Gender')),
                ...
                ('is_admitted', models.BooleanField(default=False, help_text='Variable controls whether the user has been accepted into our Organization for any number of programs.', verbose_name='Is Admitted')),
                ('stage_num', models.PositiveSmallIntegerField(db_index=True, default=1, help_text='Track what stage this User is in the system (If they are an entrepreneur).', verbose_name='Stage Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owners', models.ManyToManyField(blank=True, db_index=True, help_text='The owners of this workspace.', related_name='workspace_owners_foundation_tenant_workspace_related', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='exercise',
            name='module',
            field=models.ForeignKey(blank=True, help_text='The module this Exercise belongs to.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='exercise_module_foundation_tenant_exercise_related', to='foundation_tenant.Module'),
        ),
        migrations.AddField(
            model_name='document',
            name='document_type',
