# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-29 20:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, help_text='Physical address of the item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_address_foundation_tenant_place_related', to='foundation_tenant.PostalAddress')),
                ('geo', models.ForeignKey(blank=True, help_text='The geo coordinates of the place.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_geo_foundation_tenant_place_related', to='foundation_tenant.GeoCoordinate')),
                ('image', models.ForeignKey(blank=True, help_text='An image of the item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='thing_image_foundation_tenant_place_related', to='foundation_tenant.TenantImageUpload')),
                ('logo', models.ForeignKey(blank=True, help_text='An associated logo.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_logo_foundation_tenant_place_related', to='foundation_tenant.TenantImageUpload')),
                ('opening_hours_specification', models.ManyToManyField(blank=True, help_text='The hours during which this service or contact is available.', related_name='place_hours_available_foundation_tenant_place_related', to='foundation_tenant.OpeningHoursSpecification')),
                ...
                ('photo', models.ForeignKey(blank=True, help_text='A photograph of this place.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='place_photo_foundation_tenant_place_related', to='foundation_tenant.TenantImageUpload')),
            ],
            options={
                'verbose_name': 'Place',
