...
SMEGURUS_APP_DOCXPRESSO_FILE_PREFIX=env_var("SMEGURUS_APP_DOCXPRESSO_FILE_PREFIX")
SMEGURUS_APP_RESTRICT_SEARCH_CRAWLERS=env_var("SMEGURUS_APP_RESTRICT_SEARCH_CRAWLERS")
