...
class TenantHelpTestCases(APITestCase, TenantTestCase):
    fixtures = []
    ...
    def setUp(self):
        ...
        super(TenantHelpTestCases, self).setUp()
    ...
    def tearDown(self):
        ...
        for user in users.all():
            user.delete()
        # super(TenantHelpTestCases, self).tearDown()

    @transaction.atomic
    def test_goal_page(self):
        url = reverse('tenant_help_master')
