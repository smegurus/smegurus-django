...
urlpatterns = (
    ...
    url(r'^intake-pending/(.*)/$', employee_view.pending_intake_details_page, name='tenant_intake_employee_pending_details'),
    url(r'^intake-pending$', employee_view.pending_intake_master_page, name='tenant_intake_employee_pending_master'),
    url(r'^intake-held/(.*)/$', employee_view.held_intake_details_page, name='tenant_intake_employee_held_details'),
