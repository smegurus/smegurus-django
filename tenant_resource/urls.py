...
urlpatterns = (
    ...
    # ENTREPRENEUR
    url(r'^client/resource/category/(.*)/info/(.*)/$', client_views.info_page, name='tenant_resource_client_resource_info_details'),
    url(r'^client/resource/category/(.*)/$', client_views.category_details_page, name='tenant_resource_client_details'),
    url(r'^client/resource/category$', client_views.category_master_page, name='tenant_resource_client_category_master'),
)
