...
@register.inclusion_tag('templatetags/question/template_064.html')
def render_question_type_064(workspace, module, node, question, answer): #QID 165
    #===================#
    # CALCULATE REVENUE #
    #===================#
    ...
    scenario = compute_scenario(revenue, cogs, labour, materials, overhead, costs, fixed_costs, variable_costs)
