...
def sum_tables(array_1, array_2):
    return {
        ...
        'm_02': 0 if array_1['m_02'] == None else array_1['m_02'] + 0 if array_2['m_02'] == None else array_2['m_02'],
        'm_03': 0 if array_1['m_03'] == None else array_1['m_03'] + 0 if array_2['m_03'] == None else array_2['m_03'],
        'm_04': 0 if array_1['m_04'] == None else array_1['m_04'] + 0 if array_2['m_04'] == None else array_2['m_04'],
        'm_05': 0 if array_1['m_05'] == None else array_1['m_05'] + 0 if array_2['m_05'] == None else array_2['m_05'],
        'm_06': 0 if array_1['m_06'] == None else array_1['m_06'] + 0 if array_2['m_06'] == None else array_2['m_06'],
        'm_07': 0 if array_1['m_07'] == None else array_1['m_07'] + 0 if array_2['m_07'] == None else array_2['m_07'],
        'm_08': 0 if array_1['m_08'] == None else array_1['m_08'] + 0 if array_2['m_08'] == None else array_2['m_08'],
        'm_09': 0 if array_1['m_09'] == None else array_1['m_09'] + 0 if array_2['m_09'] == None else array_2['m_09'],
        'm_10': 0 if array_1['m_10'] == None else array_1['m_10'] + 0 if array_2['m_10'] == None else array_2['m_10'],
        'm_11': 0 if array_1['m_11'] == None else array_1['m_11'] + 0 if array_2['m_11'] == None else array_2['m_11'],
        'm_12': 0 if array_1['m_12'] == None else array_1['m_12'] + 0 if array_2['m_12'] == None else array_2['m_12'],
        'yr_1': array_1['yr_1'] + array_2['yr_1'],

        # yr2
        'm_13': 0 if array_1['m_13'] == None else array_1['m_13'] + 0 if array_2['m_13'] == None else array_2['m_13'],
        'm_14': 0 if array_1['m_14'] == None else array_1['m_14'] + 0 if array_2['m_14'] == None else array_2['m_14'],
        'm_15': 0 if array_1['m_15'] == None else array_1['m_15'] + 0 if array_2['m_15'] == None else array_2['m_15'],
        'm_16': 0 if array_1['m_16'] == None else array_1['m_16'] + 0 if array_2['m_16'] == None else array_2['m_16'],
        'm_17': 0 if array_1['m_17'] == None else array_1['m_17'] + 0 if array_2['m_17'] == None else array_2['m_17'],
        'm_18': 0 if array_1['m_18'] == None else array_1['m_18'] + 0 if array_2['m_18'] == None else array_2['m_18'],
        'm_19': 0 if array_1['m_19'] == None else array_1['m_19'] + 0 if array_2['m_19'] == None else array_2['m_19'],
        'm_20': 0 if array_1['m_20'] == None else array_1['m_20'] + 0 if array_2['m_20'] == None else array_2['m_20'],
        'm_21': 0 if array_1['m_21'] == None else array_1['m_21'] + 0 if array_2['m_21'] == None else array_2['m_21'],
        'm_22': 0 if array_1['m_22'] == None else array_1['m_22'] + 0 if array_2['m_22'] == None else array_2['m_22'],
        'm_23': 0 if array_1['m_23'] == None else array_1['m_23'] + 0 if array_2['m_23'] == None else array_2['m_23'],
        'm_24': 0 if array_1['m_24'] == None else array_1['m_24'] + 0 if array_2['m_24'] == None else array_2['m_24'],
        'yr_2': array_1['yr_2'] + array_2['yr_2'],

        # yr3
        'm_25': 0 if array_1['m_25'] == None else array_1['m_25'] + 0 if array_2['m_25'] == None else array_2['m_25'],
        'm_26': 0 if array_1['m_26'] == None else array_1['m_26'] + 0 if array_2['m_26'] == None else array_2['m_26'],
        'm_27': 0 if array_1['m_27'] == None else array_1['m_27'] + 0 if array_2['m_27'] == None else array_2['m_27'],
        'm_28': 0 if array_1['m_28'] == None else array_1['m_28'] + 0 if array_2['m_28'] == None else array_2['m_28'],
        'm_29': 0 if array_1['m_29'] == None else array_1['m_29'] + 0 if array_2['m_29'] == None else array_2['m_29'],
        'm_30': 0 if array_1['m_30'] == None else array_1['m_30'] + 0 if array_2['m_30'] == None else array_2['m_30'],
        'm_31': 0 if array_1['m_31'] == None else array_1['m_31'] + 0 if array_2['m_31'] == None else array_2['m_31'],
        'm_32': 0 if array_1['m_32'] == None else array_1['m_32'] + 0 if array_2['m_32'] == None else array_2['m_32'],
        'm_33': 0 if array_1['m_33'] == None else array_1['m_33'] + 0 if array_2['m_33'] == None else array_2['m_33'],
        'm_34': 0 if array_1['m_34'] == None else array_1['m_34'] + 0 if array_2['m_34'] == None else array_2['m_34'],
        'm_35': 0 if array_1['m_35'] == None else array_1['m_35'] + 0 if array_2['m_35'] == None else array_2['m_35'],
        'm_36': 0 if array_1['m_36'] == None else array_1['m_36'] + 0 if array_2['m_36'] == None else array_2['m_36'],
        'yr_3': array_1['yr_3'] + array_2['yr_3']
    }

def divide_tables(array_1, array_2):
    return {
        # yr1
        'm_01': 0 if array_1['m_01'] == None else array_1['m_01'] / 0 if array_2['m_01'] == None else array_2['m_01'],
        'm_02': 0 if array_1['m_02'] == None else array_1['m_02'] / 0 if array_2['m_02'] == None else array_2['m_02'],
...
def render_question_type_067(workspace, module, node, question, answer):
    ...
    # Net Profit Percent
    #------------
    net_profilt_percent = divide_tables(net_profit, salaries)
    computation = attach_table(computation, 'net_profilt_percent', net_profilt_percent)
